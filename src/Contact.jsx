  ...
  return (
    ...
    <div className="max-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white h-max w-96 py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div className="rounded-md shadow-sm -space-y-px">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  autoComplete="cc-exp"
                  className="appearance-none rounded-none relative block w-full  h-80 px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"
                  placeholder=""
                />
              </div>
            </div>
